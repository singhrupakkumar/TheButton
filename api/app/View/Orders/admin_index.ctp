<section class="admin_main-sec">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-headeing">
                    <h1 class="page-title"><i class="fa fa-bars" aria-hidden="true"></i><?php echo __('Orders'); ?></h1>
                </div>
                <div class="page_content">
                    ...
                    <div class="restaurants index">
                        <table style="font-size:12px;" id="orders" class="table table-bordered table-hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
 ...
 <script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
       ...
       $(document).delegate(".dlsts","change",function () {        
        var a = $(this).val();
