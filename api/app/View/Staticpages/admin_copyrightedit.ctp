        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-headeing">
                    <h1 class="page-title"><i class="fa fa-bars" aria-hidden="true"></i>Edit Copyright</h1>
                </div>
            ...
            <?php $x=$this->Session->flash(); ?>
                    ...
                    <?php echo $this->Form->create('Staticpage',array('id'=>'tab','type'=>'file')); ?> 
                        ...
                        <input type="hidden" class="form-control" value="copyright" name="data[Staticpage][position]">
