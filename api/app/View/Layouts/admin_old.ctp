                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><?php //echo $this->Html->link('Reserve Table', array('controller' => 'orders', 'action' => 'tableindex', 'admin' => true), array('class' => 'orders_autorizemenu')); ?></li>
...
<!--                            <li><?php 
                           ...
                           // echo $this->Html->link('Add Pincode', array('controller' => 'picodes', 'action' => 'add', 'admin' => true), array('class' => ''));  
                            // }else {
                           // echo $this->Html->link('Add Pincode', array('controller' => 'picodes', 'action' => 'adda', 'admin' => true), array('class' => '')); 
                            // }
                            ?></li>-->
...
<!--                    <li>
                        <?php // echo $this->Html->link('Alergy', array('controller' => 'alergies', 'action' => 'add', 'admin' => true), array('class' => 'alergies_autorizemenu')); ?>
                    </li>-->
                    <?php if($loggedUserRole!='rest_admin'){  ?>
<!--                        <li>
                        <?php // echo $this->Html->link('Pincode', array('controller' => 'picodes', 'action' => 'add', 'admin' => true), array('class' => 'picodes_autorizemenu')); ?>
                    </li>
                    <li>
                        <?php // echo $this->Html->link('Store Export', array('controller' => 'products', 'action' => 'csva', 'admin' => true), array('class' => 'restaurants_autorizemenu')); ?>
                    </li>
                    
                    <li>
                        <?php // echo $this->Html->link('Upload Store Image in bulk', array('controller' => 'restaurants', 'action' => 'uploadimage', 'admin' => true), array('class' => 'restaurants_autorizemenu')); ?>
                    </li>
                    <li>
                        <?php // echo $this->Html->link('Import Store', array('controller' => 'restaurants', 'action' => 'importres', 'admin' => true), array('class' => 'restaurants_autorizemenu')); ?>
                    </li>
                    <li>
                        <?php // echo $this->Html->link('Upload Product Image in bulk', array('controller' => 'restaurants', 'action' => 'prouploadimage', 'admin' => true), array('class' => 'products_autorizemenu')); ?>
                    </li>
                    
                    <li>
                        <?php // echo $this->Html->link('Import Product', array('controller' => 'products', 'action' => 'proimportres', 'admin' => true), array('class' => 'products_autorizemenu')); ?>
                    </li>
                  
                     <li><?php // echo $this->Html->link('Products CSV Export', array('controller' => 'products', 'action' => 'csv', 'admin' => true), array('class' => 'products_autorizemenu')); ?></li>-->
  <?php } ?>
                   <?php //if($loggedUserRole=='rest_admin'){  ?>  
<!--                       <li><?php //echo $this->Html->link('Recent Table Items', array('controller' => 'orders', 'action' => 'cartall', 'admin' => true), array('class' => 'autorizemenu')); ?></li>
                     <li><?php //echo $this->Html->link('Products CSV Export', array('controller' => 'products', 'action' => 'csvbyid', 'admin' => true), array('class' => 'autorizemenu')); ?></li>-->
                   <?php //}?>
