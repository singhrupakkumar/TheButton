function getPaymentPage(paymentMethod) {
    console.log('payment method works')
    console.log(paymentMethod)
    var check3ds = getUrlParameter('3ds');
    //var url = 'route.php?r=getPaymentPage';
//    if(extra_param){
//        var url = '/thoag/shop/payfortRoute?r=getPaymentPage&merchant_extra='+extra_param;
//    }else{
        var url = '/thoag/shop/payfortRoute?r=getPaymentPage';
//    }
