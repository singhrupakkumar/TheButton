...
<?php foreach ($orders as $order): ?>
            <tr>
                ...
                <td class="actions">
                        ...
                        <?php echo $this->Html->link('Edit', array('action' => 'tableedit', $order['TableReservation']['id']), array('class' => 'btn btn-default btn-xs')); ?>
...
<script type="text/javascript">
    $(".dlsts").change(function () {
        var a = $(this).val();
        $.post('http://rajdeep.crystalbiltech.com/ecasnik/admin/orders/dlstastable', {id: a}, function (d) {
            console.log(d);
        });
        //alert(a);
    });
