 ...
 * 
 */
class PayfortComponent extends Component {
    ...
    public function do_first($order_id_in_params){
            $order = ClassRegistry::init('Order')->find('first',array('conditions'=>array('Order.id'=>$order_id_in_params)));
         //   $this->amount = $order['Order']['total'];
        //    $this->order_id=$order_id_in_params;
    }
